...
# treevieweditor.py
#
# Description: a collection of generic functions and classes for creating
# BaubleTable editors based on a gtk.TreeView
#
...
# TODO: i'm not necessary proud of the TreeViewEditorDialog but it makes
# it easy to throw together a quick editor, it could probably be cleaned up
# a bit and refactored into a better architecture
