...
<%
    ...
    if doc_number != '':
        ...
        doc_type = ''
%>${v}	\
${v.accession.species.genus.family}	\
${subfamiliad[tribusd[subtribus]]}	\
${tribusd[subtribus]}	\
${subtribus}	\
${genus}	\
${species_epithet}	\
${v.accession.species.author or ''}	\
${v.accession._created.isoformat()[:10]}	\
${cites}	\
	\
	\
${doc_type}	\
