					...
					<xsl:for-each select="abcd:DataSet">
						<xsl:for-each select=".//abcd:Unit">
							...
							<fo:block-container margin=".5mm"
								keep-together="always" border="solid black 1px" width="122mm"
								height="59mm">

								<!-- ** Family ** -->
								<!--  TODO: should only select the family name if the HigherTaxonRank
									is familia -->
								<fo:block-container
									absolute-position="absolute" top="7mm" bottom="32mm">
									<fo:block
										font-family="Bitstream Vera Sans, sans" font-weight="bold"
										margin-left="5mm" margin-right="5mm" font-size="20pt"
										text-align="center">
										<xsl:value-of
								...
								<fo:block-container
									absolute-position="absolute" top="17mm" bottom="12mm">
									<fo:block line-height=".9"
										font-size="23pt" font-family="Bitstream Vera Serif, serif"
										font-style="italic" font-weight="500" margin-left="2mm"
										margin-right="2mm" text-align="center">
										<xsl:value-of
								...
								<!-- ** Vernacular name ** -->
								<fo:block-container
									absolute-position="absolute" top="33mm" bottom="12mm">
									<fo:block
										font-family="Bitstream Vera Sans, sans" font-weight="bold"
										margin-left="5mm" margin-right="5mm" font-size="22pt"
										text-align="center">
										<xsl:value-of
								...
								<!-- ** Plant ID ** -->
								<fo:block-container
									absolute-position="absolute" top="52mm" bottom="0mm" left="2mm"
									width="50mm">
									<fo:block
								...
								<fo:block-container
									absolute-position="absolute" top="52mm" bottom="0mm"
									left="50mm" right="2mm" width="70mm">
									<fo:block
										font-family="Bitstream Vera Serif, serif" font-size="15pt"
										text-align="right">
										<xsl:value-of
